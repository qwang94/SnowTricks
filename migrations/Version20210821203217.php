 ...
 */
final class Version20210821203217 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , content CLOB NOT NULL COLLATE BINARY, CONSTRAINT FK_9474526CA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9474526C5C011B5 FOREIGN KEY (figure_id) REFERENCES figure (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__figure AS SELECT id, user_id, name, description, slug, created_at FROM figure');
        ...
        $this->addSql('INSERT INTO figure (id, user_id, name, description, slug, created_at) SELECT id, user_id, name, description, slug, created_at FROM __temp__figure');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__media AS SELECT id, figure_id, name, type, source FROM media');
        $this->addSql('DROP TABLE media');
        $this->addSql('CREATE TABLE media (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, figure_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(255) NOT NULL COLLATE BINARY, source VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_6A2CA10C5C011B5 FOREIGN KEY (figure_id) REFERENCES figure (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO media (id, figure_id, name, type, source) SELECT id, figure_id, name, type, source FROM __temp__media');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526C5C011B5 ON comment (figure_id)');
        $this->addSql('DROP INDEX IDX_2F57B37AA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__figure AS SELECT id, user_id, name, description, created_at, slug FROM figure');
        $this->addSql('DROP TABLE figure');
        $this->addSql('CREATE TABLE figure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, description CLOB NOT NULL, created_at DATETIME NOT NULL, slug VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO figure (id, user_id, name, description, created_at, slug) SELECT id, user_id, name, description, created_at, slug FROM __temp__figure');
        $this->addSql('DROP TABLE __temp__figure');
        $this->addSql('CREATE INDEX IDX_2F57B37AA76ED395 ON figure (user_id)');
        $this->addSql('DROP INDEX IDX_7FEDC2FC5C011B5');
        $this->addSql('DROP INDEX IDX_7FEDC2FCFE54D947');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__media AS SELECT id, figure_id, name, type, source FROM media');
        $this->addSql('DROP TABLE media');
        $this->addSql('CREATE TABLE media (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, figure_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, source VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO media (id, figure_id, name, type, source) SELECT id, figure_id, name, type, source FROM __temp__media');
        $this->addSql('DROP TABLE __temp__media');
        $this->addSql('CREATE INDEX IDX_6A2CA10C5C011B5 ON media (figure_id)');
        $this->addSql('DROP INDEX IDX_7CE748AA76ED395');
